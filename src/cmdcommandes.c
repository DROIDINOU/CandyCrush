...
// cls
// cd /c/Users/32471/MySDL2/src
// gcc main.c matrice.c constante.c queue.c affichage.c jeu.c ressources.c erreur.c generationaleatoire.c -o mon_programme -lraylib
